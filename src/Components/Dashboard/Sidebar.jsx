  ...
  return (
      <div className="sidebar">
          <div className="menuItems">
            <span>Discover</span>
            <ul>
              <li className={activeLink === '/home' ? 'menuActive' : 'menuItem'}
                ...
                <Link className='menuLink' to="/home" onClick={()=>setActiveLink('/home')}>Home</Link>
              </li>
              <li className={activeLink === '/records' ? 'menuActive' : 'menuItem'}
              onClick={() => setActiveLink('/records')}>
                ...
                <Link className='menuLink' to='/records' onClick={() => setActiveLink('/records')}>Records</Link>
              </li>
              <li className={activeLink === '/health' ? 'menuActive' : 'menuItem'}
                ...
                <Link className='menuLink' to='/health' onClick={() => setActiveLink('/health')}>Health</Link>
              </li>
              <li className={activeLink === '/community' ? 'menuActive' : 'menuItem'}
                ...
                <Link className='menuLink' to='/community' onClick={() => setActiveLink('/community')}>Community</Link>
              </li>
              <li className={activeLink === '/saved' ? 'menuActive' : 'menuItem'}
                ...
                <Link className='menuLink' to='/saved' onClick={() => setActiveLink('/saved')}>Saved</Link>
              </li>
            </ul>
          </div>
          <hr/>
          <div style={{borderBottom: '0.003em solid #fff7cc', width: '80%', margin: 'auto'}}></div>
          <div className="bottomMenu">
            <ul>
              <li className={activeLink === '/settings' ? 'menuActive' : 'menuItem'}
              ...
              <li className='menuItem'>
                ...
                <Link className='menuLink' to='/'>Sign Out</Link>
              </li>
            </ul>
          </div>
        </div>
